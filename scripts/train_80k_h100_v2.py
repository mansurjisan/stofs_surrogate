#!/usr/bin/env python3
"""
Training Script for STOFS Surrogate - 80k nodes V2 with ENHANCED PHYSICS FEATURES
...
Usage:
    python scripts/train_80k_h100_v2.py
"""
...
# Lower batch sizes for longer rollouts to prevent OOM
ROLLOUT_SCHEDULE = {
    1:  (1, 15, 4),     # Epochs 1-15: 1-step, batch=4
    2:  (16, 30, 4),    # Epochs 16-30: 2-step, batch=4
    3:  (31, 50, 4),    # Epochs 31-50: 3-step, batch=4
...
def main():
    ...
    logger.info("=" * 70)
    logger.info("V2 TRAINING - 80k nodes - ENHANCED PHYSICS FEATURES")
    logger.info("=" * 70)
